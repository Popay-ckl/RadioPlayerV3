...
buttons = [
            ...
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/SCHOOL_WALLI_MASTII"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/POEMS_N_SHAYARU"),
            ],
            [
    ...
    if query.query == "SAF_ONE":
        answers.append(
            InlineQueryResultPhoto(
                ...
                caption=f"{REPLY_MESSAGE}\n\n<b>© Powered By : \n@ITS_HELLL_BOYYY | @SCHOOL_WALLI_MASTII 👑</b>",
